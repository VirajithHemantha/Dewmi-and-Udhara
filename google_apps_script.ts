function doPost(e: any) {
  try {
    ...
    // We use openById to connect specifically to the target sheet so this can run as a standalone web app.
    var doc = SpreadsheetApp.openById("19duW4aQfa1T6c0pzLQlxAUVrK_CKgu9gYTJlHICqwaE");
